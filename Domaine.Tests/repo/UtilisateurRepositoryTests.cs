...
namespace Domaine.Tests.repo
{
    public class UtilisateurRepositoryTests
    {
        ...
        public async Task AjouterUtilisateur_NouvelUtilisateur_AjouteASuccess()
        {
            ...
            var utilisateurDb = await dbContext.Utilisateurs.FindAsync(nouvelUtilisateur.IdUtilisateur);
        ...
        public async Task ObtenirUtilisateurs_ListeUtilisateurs_RetourneTousLesUtilisateurs()
        {
            ...
            int nbInitial = repository.ObtenirUtilisateurs().Count();
            ...
            Assert.Equal(nbInitial + 2, utilisateurs.Count());
        }
        ...
        public async Task ObtenirEmploye_FiltrageRoleEmploye_RetourneUniquementLesEmployes()
        {
            ...
            Assert.All(resultats, u => Assert.Equal(RoleUtilisateur.Employe, u.Role));
            Assert.Contains(resultats, u => u.IdUtilisateur == employe.IdUtilisateur);
        }
    }
}